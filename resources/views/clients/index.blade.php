                ...
                <table class="divide-y divide-gray-300">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">City
                            </th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">State
                            </th>
                        ...
                        @foreach ($clients as $client)
                            <tr>
                                <td class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                    {{ $client->user->name }}</td>
                                <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">{{ $client->user->email }}
                                </td>
                                <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    {{ $client->address->city }}</td>
                                <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    {{ $client->address->state }}</td>
                                <td
